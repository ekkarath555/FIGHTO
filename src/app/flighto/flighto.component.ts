...
import { Flight } from './flighto';
import { FormBuilder, FormGroup , Validators} from '@angular/forms';
import { PageService } from '../share/page.service';

@Component({
  selector: 'app-flighto',
  templateUrl: './flighto.component.html',
  styleUrls: ['./flighto.component.css']
})
export class FlightoComponent implements OnInit {
  flightData !: Flight[]
